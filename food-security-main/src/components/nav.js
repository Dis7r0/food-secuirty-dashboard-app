...
import { TotalReservesChart } from '../Data/TotalReserves';
import { GoldReservesChart } from '../Data/GoldReserves';
import { PercGNIChart } from '../Data/GNIData';
import { TotalDebtChart } from '../Data/TotalDebtData';
...
const NavBar = (props) => {
    ...
    const debt = [
        { id: 1, name: 'Reservers - imports', chart: <TotalReservesChart country={props.country} /> },
        { id: 2, name: 'Reservers - gold', chart: <GoldReservesChart country={props.country} /> },
        { id: 3, name: '% GNI', chart: <PercGNIChart country={props.country} /> },
        { id: 4, name: 'Total Debt', chart: <TotalDebtChart country={props.country} /> },
